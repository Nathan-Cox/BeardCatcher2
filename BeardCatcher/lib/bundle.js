...
/***/ function(module, exports) {
	...
	class Corgi {
	  constructor() {
	    ...
	    this.image.src = "https://res.cloudinary.com/dufw1byqv/image/upload/v1607629172/samples/beard2_qmxfnr.jpg";
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Bone extends FallingObject {
	  constructor(options = {}) {
	    options.good = true;
	    options.src = "https://res.cloudinary.com/dufw1byqv/image/upload/v1607628844/samples/bacon2_ownchr.png";
	    super(options);
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Chocolate extends FallingObject {
	  constructor(options = {}) {
	    options.good = false;
		options.src = "https://res.cloudinary.com/dufw1byqv/image/upload/v1607628837/samples/carrot2_ch42rn.jpg";
	    super(options);
	  }
	}
